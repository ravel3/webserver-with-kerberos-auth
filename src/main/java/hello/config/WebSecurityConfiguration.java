...
import hello.DummyUserDetailsService;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public SunJaasKerberosTicketValidator sunJaasKerberosTicketValidator() {
        ...
        ticketValidator.setServicePrincipal("HTTP/localhost@EXAMPLE.COM"); //At this point, it must be according to what we were given in the commands from the first step.
